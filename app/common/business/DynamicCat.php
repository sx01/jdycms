...
use app\common\model\mysql\DynamicCat as DynamicCatModel;
 

class DynamicCat extends BusBase
{
    public $model = null;

    public  function __construct()
    {
        $this->model = new DynamicCatModel();
    }
    ...
    public function getNormalDynamicCats(){
        $field = "*";
       $DynamicCats = $this->model->getNormalDynamicCats($field);
         if(!$DynamicCats){
             $DynamicCats = [];
             return  $DynamicCats;
         }
         $DynamicCats = $DynamicCats->toArray();
